...
class GiftcardDeclinedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->subject(Str::headline("Giftcard {$this->tradeType->value} transaction declined"))
            ->line(new HtmlString(
    ...
    {
        return [
            'title' => Str::headline("Giftcard {$this->tradeType->value} transaction declined"),
    ...
    public function toFirebase(mixed $notifiable): mixed
    {
        ...
        return (new FirebaseMessage())
            ->withTitle(Str::headline("Giftcard {$this->tradeType->value} transaction declined"))
            ->withBody(
